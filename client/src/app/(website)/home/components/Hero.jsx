...
const phone = data?.content?.phone;
  ...
  return (
    <section className="relative -mt-6 min-h-screen h-[700px] md:h-[800px] flex items-center justify-center overflow-hidden pt-0 mt-0">
...
{/* 
  <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ delay: 0.2 }}
          className="inline-flex mb-10 items-center gap-2 mb-4 px-4 py-2 bg-gradient-to-r from-[#FFD700]/20 via-[#D4AF7A]/20 to-[#C9A66B]/20 rounded-full backdrop-blur-sm border border-[#D4AF7A]/30"
        >
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
