...
//   `${API_BASE}/api/acceptance/confirm`,
//   {
//     method: "POST",
//     headers: {
...
//             <div className="w-16 h-16 rounded-full bg-[#e7f4df] flex items-center justify-center text-3xl mb-4">
//               ⚠️
//             </div>
...
//   // ✅ FIX: token is required and was missing
...
//     try {
//       const res = await fetchJson(
//         `${API_BASE}/api/disclaimers/booking/${token}`
//       );
