...
// import { getSignatureFromRef, clearSignatureRef, isSignaturePadEmpty } from "../../../../lib/signatureUtils";
...
//     clearSignatureRef(sigRef);
//   };

//   const getSignature = () => {
//     if (isSignaturePadEmpty(sigRef)) return null;

//     return getSignatureFromRef(sigRef);
//   };
...
export default function BookingReviewPage() {
  ...
  const getSignature = () => {
    ...
    if (!pad || isSignaturePadEmpty()) {
      return null;
    }

    const canvas =
      typeof pad.getCanvas === "function"
        ? pad.getCanvas()
        : pad.canvas || null;
